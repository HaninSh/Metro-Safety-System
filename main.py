...
def models_downloaded():
    model_files = ['Models/People_detection_weights.pt', 'Models/Line_detection_weights.pt']
...
# Main function
def main():
    video_url = 'https://drive.google.com/file/d/1RSgAJBffIClkLGqJivRr5m9hI0RrkDZ3/view?usp=drive_link'
    ...
    line_model = YOLO('Models/Line_detection_weights.pt')  # Model for detecting railway track
    person_model = YOLO('Models/People_detection_weights.pt')  # Model for detecting people
